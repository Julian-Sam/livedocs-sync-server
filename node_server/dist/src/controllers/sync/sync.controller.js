...
const responseCallback = (name, service, response) => {
    if ((0, stripe_1.isStripeResponse)(service, response)) {
        (0, stripe_1.saveStripeResponseToDB)(name, response);
    }
    else if ((0, hubspot_1.isHubspotResponse)(service, response)) {
        (0, hubspot_1.saveHubspotResponseToDB)(name, response);
    }
};
const servicesMetaData = {
    stripe: {
        apiEndpoint: "https://api.stripe.com/v1/customers",
        throttleQueue: (0, throttled_queue_1.default)(100, 1000, true), // at most 100 requests per second
    },
    hubspot: {
        apiEndpoint: "https://api.hubapi.com/crm/v3/objects/contacts",
        throttleQueue: (0, throttled_queue_1.default)(150, 1000, true), // at most 150 requests per second
    }
};
